...
export default () => (
    <div className="max-w-5xl mx-auto">
        <HeroBanner h1="Hi, my name is" h2="Nathan Luu." h3="I build stuff for the web." paragraph="I'm a student from San Diego, CA who loves designing and developing performing, user-centric, and accessible websites and apps."/>
