...
const SkillSection = ({title, skills}) => (<div className="mb-8">
    <h2 className="text-sm uppercase text-gray-700 font-medium mb-2 dark:text-gray-400">{title}</h2>
            ...
            <div className="max-w-5xl mx-auto px-4 mb-24">
                ...
                <div className="pt-6 sm:pt-0 pb-12 text-gray-800 dark:text-gray-100">
                    ...
                    <p className="max-w-4xl mt-5 text-lg md:text-xl text-gray-500 dark:text-gray-400">
                        ...
                        (STEP) intern at Google, and an entrepreneurial full-stack developer with a passion for
                        education
                ...
                <div className="relative pt-16 pb-24">
                    <div className="relative mx-auto">
                        <div className="text-left">
                            <h2 className="text-3xl leading-9 tracking-tight font-bold text-gray-800 sm:text-4xl sm:leading-10 dark:text-gray-100">
                                Projects
                            </h2>
                        </div>
                ...
                <div>
                    <h2 className="text-3xl font-bold mb-6 dark:text-gray-100">Experience</h2>
                    <ExperienceSection experiences={pageData.experience}/>
                </div>


                <div className="pt-24">
                    <h2 className="text-3xl font-bold mb-4 dark:text-gray-100">Skills</h2>
